            ...
            tools: [
                {
                    ...
                    description: 'Initialize the DAI Nexus pipeline for a new project/session. Use this when the user specifies a goal (e.g. Build a SaaS, add a feature).',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            mode: {
                ...
                },
                {
                    ...
                    description: 'Get the current phase of the DAI Nexus pipeline and its locked status. Use this to determine which skill to load.',
                    inputSchema: {
                        type: 'object',
                        properties: {},
                    },
                ...
                },
                {
                    ...
                    description: 'Update the inner action details and progress of the current pipeline phase.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            activeAction: {
                                type: ['string', 'null'],
                                description: 'A detailed description of the currently running sub-task (e.g., "Running Vitest...").',
                            },
                            phaseProgress: {
                                type: ['number', 'null'],
                ...
                },
                {
                    ...
                    description: 'Set the pipeline status to FAILED and record the reason in the execution history.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            reason: {
                ...
                },
                {
                    ...
                    description: 'Check whether DAI Nexus pipeline activation state is healthy and not stale. Use before closing substantial work.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            maxStateAgeMinutes: {
