...
* **Tiêu chuẩn nghiệm thu:** 
  * Tài liệu quy trình Spec Review Gate được lưu tại [docs/spec-review-gate.md](docs/spec-review-gate.md) (hoặc tương đương).
...
* **Tiêu chuẩn nghiệm thu:**
  * Có file checklist kiểm thử mẫu lưu tại [docs/test-case-checklist.md](docs/test-case-checklist.md) để mọi thành viên đối chiếu.
...
* **Tiêu chuẩn nghiệm thu:**
  * File biểu mẫu [docs/post-mortem-template.md](docs/post-mortem-template.md) được tạo.
