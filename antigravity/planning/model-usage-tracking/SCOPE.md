...
## Mục tiêu
Track chính xác model usage từ Cursor, Claude Code, DAI Nexus và các nền tảng khác để hiểu chi phí, tối ưu hóa, và đưa ra recommendations.
...
| DAI Nexus usage (`~/.dainexus/usage/`) | Per-skill breakdown | ✅ HIGH |
...
- [ ] Aggregate by model
- [ ] Aggregate by source (cursor, dai-nexus, claude-code)
...
2. ✅ Shows DAI Nexus usage per skill
