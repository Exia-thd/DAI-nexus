# Architecture Decisions: DAI Nexus v8.0

## Decision Log

> Auto-generated during DAI Nexus v8.0 systematic flow review. Format: `[ID] | Status | Date | Title`
...
**Rationale:**
DAI Nexus is used in production by multiple teams. Breaking changes require careful migration planning.
...
## AD-008 | Proposed | 2026-04-12 | Compare DAI Nexus Node with StakGraph

**Context:**
Research shows StakGraph as alternative code intelligence tool with Neo4j backing.

**Decision:**
Conduct feature comparison between DAI Nexus Node and StakGraph to identify gaps.

**Alternatives considered:**
1. Continue with DAI Nexus Node only — no comparison
...
**Consequences:**
- Better understanding of DAI Nexus Node position
...
**Decision:**
Evaluate Tree-sitter adoption for DAI Nexus Node to expand language support beyond current 17 languages.
