...
|----------|------|---------|
| scripts/lite/memory.py | Script | CLI for memory operations |
| .dainexus/ | Directory | Project state storage |
...
|------|---------|-----------|
| Persistent memory | memory JSONL | Cross-session |
| Session memory | .dainexus/ | Per-session |
...
| project | 8 | "DAI Nexus v7.1 — 47 skills, 19 modes" |
