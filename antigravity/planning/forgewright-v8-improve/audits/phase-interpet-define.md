...
| BA-02 | **BA package dependency** — T1 PM depends on BA package, circular dependency risk | P1 | Line 55: "if `.dainexus/business-analyst/handoff/ba-package.md` exists" | Ensure BA always runs before PM in full builds |
...
4. Write BRD to `.dainexus/product-manager/BRD/`
...
| PM-02 | **BRD location not configurable** — Hard-coded path | P2 | Line 58: `.dainexus/product-manager/BRD/` | Make configurable via `.production-grade.yaml` |
...
| H-02 | **Decisions log** — `.dainexus/decisions-log.md` but no standard format | P2 | Line 128 | Add decisions log template |
