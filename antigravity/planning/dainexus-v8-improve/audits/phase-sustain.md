...
1. Read ALL workspace folders at .dainexus/
...
6. Write workspace artifacts to .dainexus/technical-writer/
...
4. Write workspace artifacts to .dainexus/skill-maker/
...
| CL-02 | P2 | **Learnings are ephemeral** — Stored in .dainexus/ which may be gitignored | Add learnings persistence strategy |
