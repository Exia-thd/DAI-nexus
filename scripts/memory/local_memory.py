...
Please use `scripts/lite/memory.py` instead:
  ...
  python3 scripts/migrate-chroma-to-sqlite.py  # Migrate data first
...
class LocalMemoryClient:
    ...
    def __init__(self, db_path: str = "./.dainexus/memory_db"):
        ...
        self.collection = self.chroma.get_or_create_collection(
            ...
            metadata={"description": "DAI Nexus local memory"},
        )
                ...
                memories.append(
                    {
                        ...
                        "category": results["metadatas"][0][idx].get(
                            "category", "general"
                        ),
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DAI Nexus Local Memory CLI",
    ...
    add_parser.add_argument(
        "--category", "-c", default="general", help="Category (default: general)"
    )
    add_parser.add_argument(
        "--source", "-s", default="cli", help="Source (default: cli)"
    )
        ...
        if args.command == "add":
            ...
            if not results:
                ...
                for i, r in enumerate(results, 1):
                    ...
                    print(
                        f"   Score: {r.get('score', 'N/A')}, Created: {r.get('created', 'N/A')}"
                    )
                    print()
