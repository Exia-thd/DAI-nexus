...
GITHUB_DIR="/Users/Exia-thd/GitHub"
API_URL="http://localhost:3000"

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔍 DAI-NEXUS BATCH SYNC — Quét tất cả dự án"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
for project_dir in "$GITHUB_DIR"/*; do
    ...
    # Cấu hình đặc biệt của DAI Nexus
    if [ -f "$project_dir/.dainexus/project-profile.json" ]; then
        actual_targets+=(".dainexus/project-profile.json")
    fi
    if [ -f "$project_dir/.dainexus/code-conventions.md" ]; then
        actual_targets+=(".dainexus/code-conventions.md")
    fi
    ...
    if [ ${#actual_targets[@]} -gt 0 ]; then
        ...
        for target in "${actual_targets[@]}"; do
            ...
            if [ -e "$source_path" ]; then
                ...
                if [ "$target" == ".dainexus/project-profile.json" ]; then
                    dest_name="project-profile.json"
                elif [ "$target" == ".dainexus/code-conventions.md" ]; then
