...
# STRICT MODE: Fails loudly on missing python3/memory/GraphRAG prerequisites
...
MEMORY_MIDDLEWARE="$SCRIPT_DIR/../memory/memory-middleware.py"
...
# ─────────────────────────────────────────────────────────────────────────────
# STRICT CHECK 8: Test plan/next_steps recovery (requires memory)
# ─────────────────────────────────────────────────────────────────────────────
...
" 2>&1; then
    ...
    warn "SKIPPED: memory not available (strict mode requires memory)"
    warn "Plan recovery requires memory integration."
    SKIP=$((SKIP + 1))
fi

# ─────────────────────────────────────────────────────────────────────────────
# STRICT CHECK 9: Test technical details recovery (requires memory)
# ─────────────────────────────────────────────────────────────────────────────
...
" 2>&1; then
    ...
    warn "SKIPPED: memory not available (strict mode requires memory)"
    warn "Technical details recovery requires memory integration."
    SKIP=$((SKIP + 1))
fi
...
# Check 4 (memory functional) already sets FAIL if unavailable in strict mode
