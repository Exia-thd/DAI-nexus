...
AgentShield-style scanning built natively into DAI Nexus:
...
Copy `.dainexus/security/github-action.yml` to `.github/workflows/security-scan.yml`
...
```
════════════════════════════════════════════════════════════
  DAI-NEXUS SECURITY SCAN REPORT
════════════════════════════════════════════════════════════
