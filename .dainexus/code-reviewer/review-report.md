...
- **File:** [multica-hub/src/app/api/projects/setup/route.ts](multica-hub/src/app/api/projects/setup/route.ts#L32-L51)
- **Code snippet:**
  ```typescript
  execSync(`cd "${projectPath}" && git submodule add https://github.com/Exia-thd/DAI-nexus dai-nexus`, {
    stdio: 'pipe',
  });
  ```
...
- **File:** [multica-hub/src/app/api/projects/route.ts](multica-hub/src/app/api/projects/route.ts#L17-L45)
- **Code snippet:**
  ```typescript
...
- **File:** [multica-hub/src/components/hub/EnvironmentStatus.tsx](multica-hub/src/components/hub/EnvironmentStatus.tsx#L534-L553)
- **Code snippet:**
  ```typescript
...
- **File:** [multica-hub/src/app/api/projects/route.ts](multica-hub/src/app/api/projects/route.ts#L2)
- **Code snippet:**
  ```typescript
...
### 6. [LOW] Legacy Naming "DAI Nexus Node" in Environment Checks
- **File:** [multica-hub/src/components/hub/EnvironmentStatus.tsx](multica-hub/src/components/hub/EnvironmentStatus.tsx#L394-L438)
- **Description:** The status checks reference "DAI Nexus Node" for code intelligence. Per repository instructions, DAI Nexus Node is legacy and has been replaced by GitNexus.
...
- [ ] (Optional) Update "DAI Nexus Node" references to "GitNexus" in `EnvironmentStatus.tsx`.
