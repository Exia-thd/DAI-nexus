...
11. **Learning improves the project before the framework.** Reusable failures, corrections, and validated patterns may be recorded in project-local lesson/decision state and reused on later work. Shared DAI Nexus skills change only during an explicit framework-development task with deterministic regression evidence and review.
