...
│ bash scripts/dai-nexus-session-tracker.sh plan <score> │
...
- Use `scripts/dai-nexus-session-tracker.sh` to track consecutive failures
- Check: `bash scripts/dai-nexus-session-tracker.sh check`
- Record: `bash scripts/dai-nexus-session-tracker.sh plan <score>`
...
- This is NOT blocking — this IS the DAI Nexus workflow for new projects
