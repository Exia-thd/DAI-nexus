...
The schema and compiler live in the DAI Nexus installation:
...
- Project style: [READ FROM .dainexus/art-direction/game-art-contract.json]
...
[READ PALETTE FROM .dainexus/art-direction/game-art-contract.json]
...
[READ FROM .dainexus/art-direction/game-art-contract.json]
...
python3 scripts/art-direction/style-contract.py validate \
  .dainexus/art-direction/game-art-contract.json --stage generation
