...
|---|---|---|---|
| Project tech stack and rendering configurations are onboarded | `cat .dainexus/project-profile.json` | ... | run the check command and paste output |
| Style DNA contract is generation-ready | `python3 scripts/art-direction/style-contract.py validate .dainexus/art-direction/game-art-contract.json --stage generation` | ... | run the check command and paste output |
