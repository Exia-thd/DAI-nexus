...
version: 0.1.0
author: dai-nexus-skill-creator
confidence: 0.75
source_commits: 10
...
- `CLAUDE.md|scripts/dai-nexus-memory-hook.sh|scripts/memory-middleware.py|scripts/memory-session.sh`
- `.github/workflows/ci.yml|.gitignore|dainexus-node/src/agents/citations.ts|dainexus-node/src/agents/llm-client.test.ts|dainexus-node/src/agents/llm-client.ts|dainexus-node/src/agents/multi-agent.ts|dainexus-node/src/agents/prompts.test.ts|dainexus-node/src/agents/prompts.ts|dainexus-node/src/agents/skeptic.ts|dainexus-node/src/analysis/binding-verification.ts|dainexus-node/src/analysis/enclosure-cache.ts|dainexus-node/src/analysis/parallel.ts|dainexus-node/src/analysis/parse-worker.ts|dainexus-node/src/analysis/parser.ts|dainexus-node/src/analysis/queries.ts|dainexus-node/src/analysis/scanner.test.ts|dainexus-node/src/analysis/scanner.ts|dainexus-node/src/cli/evaluate.ts|dainexus-node/src/cli/query.ts|dainexus-node/src/cli/status.ts|dainexus-node/src/data/db.ts|dainexus-node/src/data/graph.test.ts|dainexus-node/src/data/groups.ts|dainexus-node/src/evaluation/dataset.ts|dainexus-node/src/evaluation/runner.ts|dainexus-node/src/mcp/tools/verify.ts|dainexus-node/src/rag/chunker.ts|dainexus-node/src/rag/hybrid-search.ts|dainexus-node/src/rag/reranker.ts|dainexus-node/src/rag/retriever.ts|package-lock.json|package.json|README.md|src/sandbox/__tests__/BypassDetector.test.ts|src/sandbox/__tests__/ConfigLoader.test.ts|src/sandbox/__tests__/FilesystemExecutor.test.ts|src/sandbox/__tests__/Integration.test.ts|src/sandbox/__tests__/PolicyEngine.test.ts|src/sandbox/config/default-config.yaml|src/sandbox/executors/FilesystemExecutor.ts|src/sandbox/executors/NetworkExecutor.ts|src/sandbox/executors/ShellExecutor.ts|src/sandbox/index.ts|src/sandbox/manager/ConfigLoader.ts|src/sandbox/manager/PolicyEngine.ts|src/sandbox/manager/SandboxManager.ts|src/sandbox/monitors/AuditLogger.ts|src/sandbox/monitors/BypassDetector.ts|src/sandbox/types/sandbox.ts|src/studio/__tests__/studio.test.ts|src/studio/components/Layout/StudioApp.tsx|src/studio/components/MemoryTrace/MemoryTrace.tsx|src/studio/components/PipelineMonitor/PipelineMonitor.tsx|src/studio/components/StatsPanel/StatsPanel.tsx|src/studio/hooks/usePipeline.ts|src/studio/hooks/useTokenTracker.ts|src/studio/index.ts|src/studio/server/eventEmitter.ts|src/studio/server/wsServer.ts|src/studio/types/studio.ts`
