...
Read Phase 3 component inventory from `.dainexus/frontend-engineer/docs/component-inventory.md`. Read Phase 4 pages from `frontend/app/pages/` for route coverage.
...
Produce `.dainexus/frontend-engineer/docs/a11y-audit.md`.
...
Produce `frontend/lighthouserc.json` and `.dainexus/frontend-engineer/docs/performance-budget.md`.
...
Produce `.dainexus/frontend-engineer/docs/browser-support.md`.
...
- `.dainexus/frontend-engineer/docs/a11y-audit.md`
- `.dainexus/frontend-engineer/docs/performance-budget.md`
- `.dainexus/frontend-engineer/docs/browser-support.md`
