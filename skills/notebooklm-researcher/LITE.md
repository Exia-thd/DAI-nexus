...
4. INTEGRATE | Save distilled lessons under `.dainexus/lessons.md` and trigger sync | Run the post-skill hooks to symlink generated documentation to the Shared Obsidian Vault.
