...
| Test artifacts | `tests/`, `.dainexus/qa-engineer/test-plan.md` | Test strategy, coverage requirements |
...
| Content inventory | `.dainexus/technical-writer/content-inventory.md` | Phase 1 priorities |
...
1. **Testing philosophy** — Testing strategy extracted from `.dainexus/qa-engineer/test-plan.md`
