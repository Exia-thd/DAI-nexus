...
1. **Check for BA package** — if `.dainexus/business-analyst/handoff/ba-package.md` exists, use it to reduce CEO interview
...
**Memory save (Gate 1):**
```bash
python scripts/lite/memory.py add "Gate 1 approved: BRD for [project]. Key decisions: [list top 3]" --category decisions
```
