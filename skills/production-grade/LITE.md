...
| MCP tools available | Check if `dn_start_pipeline` is callable | ... | run the check command and paste output |
...
- `n. Start pipeline | dn_start_pipeline | Pipeline ID returned`
- `n. Advance phase | dn_advance_phase | Phase name updated`
- `n. Request gate approval | dn_request_gate_approval | Gate status logged`
