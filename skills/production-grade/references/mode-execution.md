...
- Bootstrap workspace: `mkdir -p skills/_shared/protocols/ .dainexus/`
...
| 4 | **Lessons written?** | Append to skill SKILL.md + .dainexus/lessons.md |
...
| 12 | **ASIP metrics updated?** | Increment counters in .dainexus/asip-metrics.json |
