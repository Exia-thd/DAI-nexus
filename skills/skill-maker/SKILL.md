...
DAI Nexus can auto-generate skills from git history analysis using `scripts/dai-nexus-skill-create.sh`.
...
bash scripts/dai-nexus-skill-create.sh --pattern "auth" --name "auth-expert"

# Analyze remote repo
bash scripts/dai-nexus-skill-create.sh --from-repo https://github.com/user/repo --name "user-repo"

# Interactive mode
bash scripts/dai-nexus-skill-create.sh --interactive
```
