...
# Visual
dai test update-baseline           # Only after explicit current visual requirement/reference change
dai test compare --baseline v1     # Compare versions

# Fix Mode
dai test fix                      # Auto-fix implementation/infrastructure; behavioral oracles stay read-only
dai test fix --strategy aggressive # Aggressive implementation repair; never weakens test expectations
