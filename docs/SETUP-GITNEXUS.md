...
> **GitNexus** is the recommended code intelligence tool for DAI Nexus projects. It provides 38K+ stars, npm installation, auto-setup for all editors, and 16 MCP tools for deep code understanding.

## Why GitNexus?

| Feature | GitNexus | DAI Nexus Node (Legacy) |
|---------|----------|---------------------|
...
## DAI Nexus Integration

DAI Nexus uses GitNexus for:
...
## Migration from DAI Nexus Node

If you were using DAI Nexus Node:
...
# Change dainexus-node_* to gitnexus_*
```

DAI Nexus Node can be safely removed after migration:

```bash
rm -rf /path/to/dai-nexus/dainexus-node
```
