...
Để xử lý tận gốc nỗi đau này, DAI Nexus v8.8.0 chính thức ra mắt bộ nâng cấp khâu tiếp nhận đầu vào (Interpret & Define) siêu nghiêm ngặt:
...
Giờ đây, bạn có đưa Specs mơ hồ thế nào, DAI Nexus cũng sẽ gặng hỏi bằng được để ra specs chuẩn chỉnh. Chậm một chút ở khâu chuẩn bị, nhưng đầu ra cam kết không lọt lỗi!
