    ...
    <li>
      <article class="layer-card">
        ...
        <div class="layer-content">
          ...
          <p>MCP Servers &middot; GitNexus &middot; Scripts (53) &middot; State (.dainexus/)</p>
        </div>
      </article>
    </li>
  </ol>
...
<section class="architecture-diagram architecture-fluxmem" aria-labelledby="diagram-fluxmem-title">
  ...
  <div class="fluxmem-grid">
    ...
    <article class="fluxmem-panel">
      <h3>Scripts</h3>
      <ul>
        <li>scripts/lite/memory.py <span># CLI: add, search, stats, decay</span></li>
    ...
    <article class="fluxmem-panel">
      <h3>Memory Bank (.dainexus/memory-bank/)</h3>
      <ul>
