...
> Master index of all Cursor rules for the DAI Nexus project.
> Managed by DAI Nexus — auto-generated from skill audit.
...
|| # | Rule | File | Purpose |
|--|---|------|------|---------|
| 1 | Pipeline Enforcement | `.cursor/rules/01-dai-nexus-pipeline.md` | Force Step 0 + Step 0.5 before ANY execution |
...
| Hook | File | Purpose |
|------|------|---------|
| Activation Rules | `skills/production-grade/hooks/activation-rules.json` | Maps user prompts → DAI Nexus skills |
