...
CANONICAL_TSX="$TEST_HOME/.dainexus/mcp-server/node_modules/.bin/tsx"
...
run_launcher() {
    ...
    HOME="$TEST_HOME" DAINEXUS_DEBUG=1 DAINEXUS_WORKSPACE="$workspace" FAKE_NPX_OUTPUT="$FAKE_NPX_OUTPUT" bash "$LAUNCHER" >/dev/null 2>"$TEST_ROOT/stderr"
}
